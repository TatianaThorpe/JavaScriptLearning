...
//
//     var questionArray = [];
//     questionArray.push(new Question('What is the capital of China?', ['0:Kong Kong', ' 1:Beijing', ' 2:Tokyo'], 1));
//     questionArray.push(new Question('What is the capital of France?', ['0:Calais', ' 1:Nice', ' 2:Paris'], 2));
//     questionArray.push(new Question('What is the capital of Spain?', ['0:Madrid', ' 1:Barcelona', ' 2:Seville'], 0));
//
//     var choose = Math.round(Math.random() * 2);
//     console.log(choose);
//     console.log(questionArray[choose]);
//
//     var guess = prompt(questionArray[choose].question + ': \n' + questionArray[choose].possibleAnswers);
//     console.log(guess);
//
//     if (guess === questionArray[choose].correctAnswer) {
